...
const writingEntries = [
  {
    ...
    desc: 'Symbolic regression as a self-improvement testbed: evolution, greedy RL, and risk-seeking RL race to recover a hidden equation — then swap the search policy for an LLM.',
  ...
  },
  {
    ...
    desc: 'A map of the self-improvement family — AlphaZero, STaR, RLVR, FunSearch, AlphaEvolve — and the frontier where the model rewrites its own weights mid-inference.',
    tags: ['self-improvement'],
  },
  {
    ...
    desc: 'SFT, reward models, PPO, and the modern simplifications (DPO, GRPO) side-by-side, with the RL math made geometric.',
    tags: ['rlhf'],
  },
  {
    ...
    desc: 'The geometric story of why Llama, Mistral, Qwen, and DeepSeek all rotate Q and K in 2D pairs — and how relative position falls out of the dot product for free.',
    tags: ['positions'],
  },
  {
    ...
    desc: 'Why the first token takes 500 ms and the rest stream at 20 ms each — KV cache, arithmetic intensity, GQA, PagedAttention, continuous batching.',
    tags: ['inference'],
  },
  {
    ...
    desc: 'An interactive walk through self-attention — from token embeddings to causal masking — with every matrix small enough to read by eye.',
    tags: ['transformers'],
  },
  {
    slug: 'monte-carlo',
